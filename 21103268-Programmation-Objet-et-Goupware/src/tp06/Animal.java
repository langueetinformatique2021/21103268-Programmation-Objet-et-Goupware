...
public abstract class Animal {
	...
	/** cri de l'animal */
	public abstract void crie(); //classe abstraite qui contient des méthodes abstraites
	// classe abstraite sert à forcer une classe dérivée à implémenter une méthode abstraite
}
